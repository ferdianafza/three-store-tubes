                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-list.html" class="nav-item nav-link">Produk</a>
                            <a href="product-detail.html" class="nav-item nav-link">Detail Produk</a>
                            <a href="checkout.html" class="nav-item nav-link">Checkout</a>
                            <a href="my-account.html" class="nav-item nav-link">Akun Saya</a>
                        </div>
                        <div class="navbar-nav ml-auto">
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">User Account</a>
                                <div class="dropdown-menu">
                                    <a href="login.html" class="dropdown-item">Masuk/Buat Akun</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="index.html">
                                <img src="img/LOGO KITA.PNG" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <!-- Breadcrumb End -->
                    ...
                    <div class="col-lg-12">
                        <div class="contact-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15844.452483738303!2d107.5347590726957!3d-6.877048387618982!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e5c7d8235a61%3A0x277aab6fe377a757!2sCimahi%20Mall!5e0!3m2!1sid!2sid!4v1684311655957!5m2!1sid!2sid" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>
